    ...
    <Table className="w-full table-auto">
      <TableHeader>
        <TableRow className="bg-primary-0/20 border-primary-0/50">
          <TableHead className="text-typography-1 text-xs">Ступень</TableHead>
          <TableHead className="text-typography-1 text-xs">Норма</TableHead>
        </TableRow>
      </TableHeader>
      <ScrollView className="w-full max-h-90">
        <TableBody>
          ...
          >
            <TableData className="font-bold text-typography-1 text-xs">
              Высокая
            </TableData>
            <TableData className="font-bold text-typography-1 text-xs">
              {standards.highValue}
